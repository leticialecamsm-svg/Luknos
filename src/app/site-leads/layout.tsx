...
export default async function SiteLeadsLayout({ children }: { children: React.ReactNode }) {
  const { profile, allowedPages, roleLabel } = await requirePageAccess('/site-leads')
  return (
