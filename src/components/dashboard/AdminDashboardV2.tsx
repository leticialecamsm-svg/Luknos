    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-3">
        <div onClick={() => setDetail({ title: 'Vendas fechadas no mês (recebido)', items: closedThisMonth, field: 'recebido' })}
          className="cursor-pointer bg-gradient-card rounded-card shadow-card border border-surface-border p-4 relative overflow-hidden hover:shadow-md hover:border-green-300 transition-all">
        ...
        <div onClick={() => setDetail({ title: 'Oportunidades em aberto', items: quotes.filter(q => !['closed', 'lost'].includes(q.temperature ?? 'cold')), field: 'quoted' })}
          className="cursor-pointer bg-gradient-card rounded-card shadow-card border border-surface-border p-4 relative overflow-hidden hover:shadow-md hover:border-blue-300 transition-all">
        ...
        <div onClick={() => setDetail({ title: 'Vendas fechadas (ticket médio, recebido)', items: closedThisMonth, field: 'recebido' })}
          className="cursor-pointer bg-gradient-card rounded-card shadow-card border border-surface-border p-4 relative overflow-hidden hover:shadow-md hover:border-amber-300 transition-all">
        ...
        <div onClick={() => setDetail({ title: 'Vendas fechadas (taxa de conversão)', items: closedThisMonth, field: 'final' })}
          className="cursor-pointer bg-gradient-card rounded-card shadow-card border border-surface-border p-4 relative overflow-hidden hover:shadow-md hover:border-purple-300 transition-all">
        ...
        <div onClick={() => setDetail({ title: 'Negociações perdidas no mês', items: lostThisMonth, field: 'quoted' })}
          className="cursor-pointer bg-gradient-card rounded-card shadow-card border border-surface-border p-4 relative overflow-hidden hover:shadow-md hover:border-red-300 transition-all">
        ...
        <div onClick={() => setDetail({ title: 'Orçamentos quentes', items: quotes.filter(q => q.temperature === 'hot'), field: 'quoted' })}
          className="cursor-pointer bg-gradient-card rounded-card shadow-card border border-surface-border p-4 relative overflow-hidden hover:shadow-md hover:border-orange-300 transition-all">
        ...
        <div className="bg-gradient-card rounded-card shadow-card border border-surface-border p-4 relative overflow-hidden">
      ...
      {flaggedAlerts.length > 0 && (
        <div className="bg-gradient-card rounded-card shadow-card border border-amber-200/60 overflow-hidden">
      ...
      {criticalNegotiations.length > 0 && (
        <div className="bg-gradient-card rounded-card shadow-card border border-orange-200/60 overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-gradient-card rounded-card shadow-card border border-surface-border overflow-hidden">
          <div className="border-b border-surface-border px-4 py-3 flex items-center justify-between">
            <h3 className="text-sm font-semibold text-gray-900">Faturamento mensal <span className="bg-gradient-navy text-white text-xs font-bold px-2 py-0.5 rounded ml-2">2026</span></h3>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-gradient-card rounded-card shadow-card border border-surface-border overflow-hidden">
          <div className="border-b border-surface-border px-4 py-3 flex items-center justify-between">
            <h3 className="text-sm font-semibold text-gray-900">Top parceiros <span className="bg-gradient-navy text-white text-xs font-bold px-2 py-0.5 rounded ml-2">por volume</span></h3>
