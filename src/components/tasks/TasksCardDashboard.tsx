...
export function TasksCardDashboard({ onNewTaskClick }: TasksCardProps) {
  ...
  if (loading) {
    return (
      <div className="bg-white rounded-xl border-2 p-6" style={{
        borderImage: 'linear-gradient(135deg, #FCD34D, #FBBF24) 1'
      }}>
  ...
  return (
    <div className="bg-white rounded-2xl p-6 space-y-4" style={{
      border: '2px solid',
      borderImage: 'linear-gradient(135deg, #FCD34D 0%, #FBBF24 100%) 1',
    }}>
      {/* Header */}
